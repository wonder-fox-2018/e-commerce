    ...
    methods: {
        ...
        addCategory() {
            if (this.newCatName.length > 0 && this.newCatIcon.length > 0) {
                axios({
                    url: 'https://shoeka-server.ismailnagib.xyz/categories',
                    method: 'post',
                    headers: {
        ...
        addProduct() {
            if (this.newProName.length > 0 && this.newProDesc.length > 0 && this.newProBT.length > 0 && this.newProPrice.length > 0 && this.newProCat.length > 0 && this.newProImg.length !== '') {
                ...
                axios({
                    url: `https://shoeka-server.ismailnagib.xyz/upload`,
                    method: 'post',
                    data: formData,
                    headers: {
                ...
                .then(image => {
                    axios({
                        url: 'https://shoeka-server.ismailnagib.xyz/products',
                        method: 'post',
                        headers: {
                            token: localStorage.getItem('token')
                        },
        ...
        editCategory() {
            if (this.newCatName.length > 0 && this.newCatIcon.length > 0 && this.selectedCat.length > 0) {
                ...
                axios({
                    url: `https://shoeka-server.ismailnagib.xyz/categories/${id}`,
                    method: 'put',
                    headers: {
                        token: localStorage.getItem('token')
                    },
        ...
        editProduct() {
            if (this.newProName.length > 0 && this.newProDesc.length > 0 && this.newProBT.length > 0 && this.newProPrice.length > 0 && this.newProCat.length > 0) {
                ...
                axios({
                    url: `https://shoeka-server.ismailnagib.xyz/products/${id}`,
                    method: 'put',
                    headers: {
                        token: localStorage.getItem('token')
                    },
        ...
        promote() {
            axios({
                url: 'https://shoeka-server.ismailnagib.xyz/users/promote',
                method: 'patch',
                headers: {
                    token: localStorage.getItem('token')
                },
